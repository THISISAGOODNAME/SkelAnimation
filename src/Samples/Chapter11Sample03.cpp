...
void Chapter11Sample03::Initialize() {
...
void Chapter11Sample03::Update(float deltaTime) {
...
void Chapter11Sample03::Render(float inAspectRatio) {
...
void Chapter11Sample03::Shutdown() {
...
void Chapter11Sample03::ImGui(nk_context* ctx) {
    nk_begin(ctx, "Chapter 11, Sample 03", nk_rect(5.0f, 5.0f, 300.0f, 165.0f), NK_WINDOW_BORDER | NK_WINDOW_NO_SCROLLBAR);
